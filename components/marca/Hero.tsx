      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        >
          ...
          <div className="relative z-10 mx-6 mt-6 aspect-[16/11] overflow-hidden rounded-[1.5rem] sm:mx-10 sm:mt-10 lg:hidden">
            ...
            />
            <div className="absolute bottom-3 left-3 right-3 flex items-center gap-2 rounded-xl bg-white/95 px-3 py-2 shadow-lg">
          ...
          >
            <div className="relative aspect-[6/5] w-full max-w-md">
              ...
              <div className="absolute left-4 top-1/2 w-[72%] -translate-y-1/2 rounded-2xl bg-white/95 p-4 shadow-xl backdrop-blur-sm">
